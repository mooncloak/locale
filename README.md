...
Checkout the [releases page](https://github.com/mooncloak/locale/releases) to get the latest version.
<br/><br/>
<img alt="GitHub tag (latest by date)" src="https://img.shields.io/github/v/tag/mooncloak/locale">
...
```kotlin
implementation("com.mooncloak.kodetools.locale:locale-core:VERSION")
```
